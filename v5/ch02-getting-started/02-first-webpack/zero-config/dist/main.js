          ...
          function () {
            ...
            var ar = Dt({
              ...
              cr = (function n(t) {
                ...
                function Ju(n, t, r, e) {
                  return n === u || (Fo(n, Sn[r]) && !Cn.call(e, r)) ? t : n;
                }
                ...
                var No = qu(Oe),
                  ...
                  qo = ze(
                    ...
                    : function (n) {
                        return (
                          rf(n) && Cn.call(n, 'callee') && !tt.call(n, 'callee')
                        );
                      },
                  Zo = e.isArray,
                  Ko = ht
                ...
                function lf(n) {
                  return 'symbol' == typeof n || (rf(n) && Ae(n) == E);
                }
                var sf = yt
                    ? qt(yt)
                    : function (n) {
    ...
    (() => {
      ...
      document.body.appendChild(
        (function () {
          ...
          return (n.innerHTML = t().join(['Hello', ', ', 'world', '!'], '')), n;
        })()
      );
    })();
})();
